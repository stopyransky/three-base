...
const filterEmptyLine = (str: string): boolean => str !== '';
...
function ShaderGenerator(renderer, parameters) {
  ...
  // const defines = parameters.defines;
	...
	const customDefines = generateDefines( parameters.defines );
...
function loopReplacer( match, start: string, end: string, snippet ) {
...
function replaceClippingPlaneNums( str, parameters ) {
